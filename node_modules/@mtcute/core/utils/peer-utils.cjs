...
function getMarkedPeerId(peer, peerType) {
  if (typeof peer === "number") {
    ...
    throw new errors.MtArgumentError("Invalid peer type");
  }
  switch (peer._) {
  ...
  throw new errors.MtArgumentError(`Invalid peer: ${peer._}`);
}
function parseMarkedPeerId(id) {
  ...
  throw new errors.MtArgumentError(`Invalid marked peer id: ${id}`);
}
