...
class NetworkManager {
  ...
  async _getOtherDc(dcId) {
    if (this._destroyed) {
      throw new errors.MtcuteError("Network manager is destroyed");
    }
