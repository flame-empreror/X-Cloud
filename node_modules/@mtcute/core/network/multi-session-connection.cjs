...
const sessionConnection = require("./session-connection.cjs");
class MultiSessionConnection {
  ...
  onRequestKeys = new utils.Emitter();
  ...
  _updateConnections(connect = false) {
    ...
    for (let i = this._connections.length; i < this._count; i++) {
      const conn = new sessionConnection.SessionConnection(
        {
          ...this.params,
...
exports.MultiSessionConnection = MultiSessionConnection;
