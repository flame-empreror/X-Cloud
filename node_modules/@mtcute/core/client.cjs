...
class TelegramClient {
  ...
  constructor(opts) {
    ...
    this.onNewEphemeralMessage = new utils.Emitter();
    this.onEditEphemeralMessage = new utils.Emitter();
    this.onDeleteEphemeralMessages = new utils.Emitter();
    this.onEphemeralCallbackQuery = new utils.Emitter();
    if ("client" in opts) {
...
TelegramClient.prototype.banCommunityParticipant = function(...args) {
  return banCommunityParticipant.banCommunityParticipant(this._client, ...args);
};
TelegramClient.prototype.unbanCommunityParticipant = function(...args) {
  return banCommunityParticipant.unbanCommunityParticipant(this._client, ...args);
};
TelegramClient.prototype.createCommunity = function(...args) {
  return createCommunity.createCommunity(this._client, ...args);
};
TelegramClient.prototype.getCommunityLinkRequests = function(...args) {
  return getCommunityLinkRequests.getCommunityLinkRequests(this._client, ...args);
};
TelegramClient.prototype.getCommunityParticipantChats = function(...args) {
  return getCommunityParticipantChats.getCommunityParticipantChats(this._client, ...args);
};
TelegramClient.prototype.getJoinedCommunities = function(...args) {
  return getJoinedCommunities.getJoinedCommunities(this._client, ...args);
};
TelegramClient.prototype.hideCommunityLinkRequest = function(...args) {
  return hideCommunityLinkRequest.hideCommunityLinkRequest(this._client, ...args);
};
TelegramClient.prototype.hideAllCommunityLinkRequests = function(...args) {
  return hideCommunityLinkRequest.hideAllCommunityLinkRequests(this._client, ...args);
};
TelegramClient.prototype.linkCommunityPeer = function(...args) {
  return linkCommunityPeer.linkCommunityPeer(this._client, ...args);
};
TelegramClient.prototype.unlinkCommunityPeer = function(...args) {
  return linkCommunityPeer.unlinkCommunityPeer(this._client, ...args);
};
TelegramClient.prototype.toggleCommunityCollapsed = function(...args) {
  return toggleCommunityCollapsed.toggleCommunityCollapsed(this._client, ...args);
};
...
TelegramClient.prototype.appendTodoList = function(...args) {
  return appendTodoList.appendTodoList(this._client, ...args);
};
...
TelegramClient.prototype.toggleTodoCompleted = function(...args) {
  return toggleTodoCompleted.toggleTodoCompleted(this._client, ...args);
};
