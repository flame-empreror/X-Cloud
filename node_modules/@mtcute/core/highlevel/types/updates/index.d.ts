import { BusinessConnection, EphemeralMessage, Message } from '../../types/index.js';
...
export type ParsedUpdate = {
    ...
    name: 'new_ephemeral_message';
    data: EphemeralMessage;
} | {
    name: 'edit_ephemeral_message';
    data: EphemeralMessage;
} | {
    name: 'delete_ephemeral_messages';
    data: DeleteEphemeralMessagesUpdate;
} | {
    name: 'ephemeral_callback_query';
    data: EphemeralCallbackQuery;
};
