...
function _messageActionFromTl(act) {
  switch (act._) {
    ...
    case "messageActionChatEditPhoto":
      ...
      return {
        type: "photo_changed",
        photo: new photo.Photo(act.photo)
      };
    ...
    case "messageActionPaymentSentMe":
      return {
        ...
        charge: act.charge,
        subscriptionUntilDate: act.subscriptionUntilDate ? new Date(act.subscriptionUntilDate * 1e3) : void 0
      };
    ...
    case "messageActionRequestedPeer":
      return {
        type: "peer_chosen",
        buttonId: act.buttonId,
        peers: act.peers.map((it) => peer.parsePeer(it, this._peers))
      };
    ...
    case "messageActionPaymentRefunded":
      return {
        ...
        currency: act.currency,
        peerId: peerUtils.getMarkedPeerId(act.peer),
        amount: act.totalAmount,
        payload: act.payload,
        charge: act.charge
      };
...
exports._messageActionFromTl = _messageActionFromTl;
