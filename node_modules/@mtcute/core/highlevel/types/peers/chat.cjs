...
const chatPhoto = require("./chat-photo.cjs");
...
class Chat {
  ...
  get id() {
    return peerUtils.getMarkedPeerId(this.inputPeer);
  }
  /**
    ...
    switch (this.raw._) {
      ...
      case "communityForbidden":
        ...
        if (!this.raw.accessHash) {
          throw new errors.MtArgumentError("Peer's access hash is not available!");
        }
        return {
          _: "inputPeerChannel",
          channelId: this.raw.id,
  ...
  get chatType() {
    switch (this.raw._) {
      ...
      case "channelForbidden":
        ...
        throw new errors.MtArgumentError("Unknown chat type");
    }
  }
  /**
  ...
  get usernames() {
    ...
    return this.raw.usernames ?? (this.raw.username ? [{ _: "username", username: this.raw.username, active: true }] : null);
  }
  /**
   ...
   */
  get photo() {
    if (!("photo" in this.raw) || this.raw.photo?._ !== "chatPhoto") {
      return null;
    }
    return new chatPhoto.ChatPhoto(this.inputPeer, this.raw.photo);
  }
  /**
  ...
  get permissions() {
    ...
    return new chatPermissions.ChatPermissions(this.raw.bannedRights);
  }
  /**
  ...
  get defaultPermissions() {
    ...
    return new chatPermissions.ChatPermissions(this.raw.defaultBannedRights);
  }
  /**
  ...
  get joinDate() {
    return this.isMember && "date" in this.raw ? new Date(this.raw.date * 1e3) : null;
  }
  ...
  mention(text) {
    ...
    return new messageEntity.MessageEntity(
      {
...
const Chat$1 = /* @__PURE__ */ memoize.memoizeGetters(Chat, [
  "inputPeer",
  "chatType",
  "usernames",
  "photo",
...
const Chat$2 = /* @__PURE__ */ inspectable.makeInspectable(Chat$1, []);
exports.Chat = Chat$2;
