...
class User {
  ...
  raw;
  constructor(user) {
    typeAssertions.assertTypeIs("User#init", user, "user");
    this.raw = user;
  }
  ...
  get inputPeer() {
    ...
    if (!this.raw.accessHash) {
      throw new errors.MtArgumentError("user's access hash is not available!");
    }
    return {
      _: "inputPeerUser",
      userId: this.raw.id,
...
const User$1 = /* @__PURE__ */ memoize.memoizeGetters(User, [
  "_parsedStatus",
  "usernames",
  "inputPeer",
  "photo",
...
const User$2 = /* @__PURE__ */ inspectable.makeInspectable(User$1, void 0, ["_parsedStatus"]);
exports.User = User$2;
