...
export default function App() {
    ...
    return (
      <div className="min-h-screen mesh-gradient noise-overlay flex items-center justify-center">
        ...
        >
          ...
          <p className="text-zinc-400 text-sm">Initializing secure connection...</p>
  ...
  if (error) {
    return (
      <div className="min-h-screen mesh-gradient noise-overlay flex items-center justify-center p-4">
        <motion.div
          ...
          <div className="relative">
            ...
            <div className="relative glass-strong rounded-3xl p-8">
              <div className="text-center">
                <div className="relative w-20 h-20 mx-auto mb-6">
                  <div className="absolute inset-0 bg-red-500/20 rounded-3xl blur-xl animate-pulse-glow" />
                  <div className="relative w-full h-full bg-red-500/10 border border-red-500/20 rounded-3xl flex items-center justify-center">
                    <svg className="w-10 h-10 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                  </div>
                </div>
                <h2 className="text-white text-2xl font-bold mb-2">Configuration Error</h2>
                <p className="text-zinc-400 text-sm mb-6 leading-relaxed">{error}</p>
                <button
                  onClick={() => window.location.reload()}
                  className="btn-modern btn-primary-modern px-6 py-3 rounded-xl font-medium"
                >
                  Retry Connection
                </button>
              </div>
